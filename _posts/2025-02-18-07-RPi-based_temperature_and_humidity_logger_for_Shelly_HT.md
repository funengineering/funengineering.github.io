...
If you have multiple Shelly H&T sensors, you might want to integrate all of them into your setup. This is the topic of the next part of this tutorial.

If you have one sensor, skip the optional next part and continue with the visualization of the data you are now collecting.
